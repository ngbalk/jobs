job('struts-job') {
    ...
    steps {
        ...
        shell('curl -u admin:admin123 -X POST -H "Content-Type: application/json" -d \'{"publicId": "struts-scanPoop","name": "MyStrutsScanPoop","organizationId":"c33c55b5822d42ec92cdc75904438132"}\' \'localhost:8070/api/v2/applications\'')
    }
